...
class UARTDriver:
    ...
    def __init__(self, **kwargs):
        ...
        self._fields = {'LED': {'registers': {'leds0': {'width': 4, 'lsbit_total_bit_position': 0, 'lsbit_address': 0, 'lsbit_address_bit_position': 0, 'msbit_total_bit_position': 3, 'msbit_address': 0, 'msbit_address_bit_position': 3}, 'leds1': {'width': 4, 'lsbit_total_bit_position': 4, 'lsbit_address': 0, 'lsbit_address_bit_position': 4, 'msbit_total_bit_position': 7, 'msbit_address': 0, 'msbit_address_bit_position': 7}}, 'start_address': 0, 'end_address': 0}, 'RESET': {'registers': {'reset': {'width': 1, 'lsbit_total_bit_position': 8, 'lsbit_address': 1, 'lsbit_address_bit_position': 0, 'msbit_total_bit_position': 8, 'msbit_address': 1, 'msbit_address_bit_position': 0}}, 'start_address': 1, 'end_address': 1}}
#-------------------------------------------------------------------------------
