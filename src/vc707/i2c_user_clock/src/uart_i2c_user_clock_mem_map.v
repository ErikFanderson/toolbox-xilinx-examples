...
output wire reset,
output wire rv0_valid,
input wire rv0_ready,
output wire [6:0] rv0_slave_address,
output wire [7:0] rv0_reg_address,
output wire [1:0] rv0_burst_count,
...
/* Field: I2C */
/**************/
// Assigns for register: rv0_valid
assign flat_uart_i2c_user_clock_read_mem[`rv0_valid_Sel] = rv0_valid;
assign rv0_valid = flat_uart_i2c_user_clock_write_mem[`rv0_valid_Sel];
...
// Assigns for register: rv0_reg_address
assign flat_uart_i2c_user_clock_read_mem[`rv0_reg_address_Sel] = rv0_reg_address;
assign rv0_reg_address = flat_uart_i2c_user_clock_write_mem[`rv0_reg_address_Sel];
// Assigns for register: rv0_burst_count
assign flat_uart_i2c_user_clock_read_mem[`rv0_burst_count_Sel] = rv0_burst_count;
assign rv0_burst_count = flat_uart_i2c_user_clock_write_mem[`rv0_burst_count_Sel];
