...
// Assigns for register: i2c_rst_n
assign flat_uart_i2c_user_clock_read_mem[`i2c_rst_n_Sel] = i2c_rst_n;
assign i2c_rst_n = flat_uart_i2c_user_clock_write_mem[`i2c_rst_n_Sel];
...
// Assigns for register: rv1_nack
assign flat_uart_i2c_user_clock_read_mem[`rv1_nack_Sel] = rv1_nack;
